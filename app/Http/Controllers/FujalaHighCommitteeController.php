...
use App\Models\FujalaHighCommittee;
use App\Models\FujalaHighCommitteeDetail;
use App\Http\Requests\StoreFujalaHighCommitteeRequest;
use App\Http\Requests\UpdateFujalaHighCommitteeRequest;
...
class FujalaHighCommitteeController extends Controller
{
    /**
    ...
    {
        return view('fuajala_high_committee_add');
    }


    public function get_fujala_high_committees_data(Request $request){



              $fujala_high_committee_latest_result=FujalaHighCommittee::orderBy('expiry_date','desc')->limit(1)->get();

        $present_committee=[];

        $present_committee_id=0;

        foreach($fujala_high_committee_latest_result as $fujala_high_committee_indiv){
            
            $present_committee_id=$fujala_high_committee_indiv['id'];
...
$current_committee_query=FujalaHighCommittee::
        
        join('fujala_high_committee_details',
            'fujala_high_committees.id', '=',
            'fujala_high_committee_details.fujala_high_committee_id')
        ->where('fujala_high_committees.id','=',$present_committee_id)
        ->select('fujala_high_committees.*','fujala_high_committee_details.*', 
            'fujala_high_committee_details.id as fujala_high_committee_detail_id_found',
            'fujala_high_committees.id as fujala_high_committee_id_found'
        ...
        $all_committees_old= FujalaHighCommittee::where('id','!=',$present_committee_id)->get();
    ...
    }// end of function get_fujala_high_committees_data


    public function get_fujala_high_committees_data_indiv(Request $request, $id){
...
// \DB::enableQueryLog(); // Enable query log
        ...
        $current_committee_query=FujalaHighCommittee::
            ...
            join('fujala_high_committee_details',
                'fujala_high_committees.id', '=',
                'fujala_high_committee_details.fujala_high_committee_id')
            ->where('fujala_high_committees.id','=',$id)
            ->select('fujala_high_committees.*','fujala_high_committee_details.*', 
                'fujala_high_committee_details.id as fujala_high_committee_detail_id_found',
                'fujala_high_committees.id as fujala_high_committee_id_found'
    ...
    }// end of function get_fujala_high_committees_data_indiv


    public function show_all_fujala_high_committee(Request $request)
    {
        
         $fujala_high_committee_all=FujalaHighCommittee::all();

        return view('fujala_high_committee_all', compact('fujala_high_committee_all'));

    }//end of method show_all_fujala_high_committee

    /**
     * Store a newly created resource in storage.
     *
     * @param  \App\Http\Requests\StoreFujalaHighCommitteeRequest  $request
     * @return \Illuminate\Http\Response
     */
    public function store(StoreFujalaHighCommitteeRequest $request)
    {
        ...
        $committee=FujalaHighCommittee::create([
        ...
        for($i=0; $i<$total_persons; $i++){
                ...
                $info=[
                    'fujala_high_committee_id'=>$committee_id,
                ...
                FujalaHighCommitteeDetail::create($info);
     ...
     *
     * @param  \App\Models\FujalaHighCommittee  $fujalaHighCommittee
     * @return \Illuminate\Http\Response
     */
    public function show(FujalaHighCommittee $fujalaHighCommittee, $id)
    {
        $fujala_high_committee_info=FujalaHighCommittee::
        
        join('fujala_high_committee_details','fujala_high_committees.id', '=',
            'fujala_high_committee_details.fujala_high_committee_id')
        ->where('fujala_high_committees.id','=',$id)
        ->select('fujala_high_committees.*','fujala_high_committee_details.*', 
            'fujala_high_committee_details.id as   fujala_high_committee_details_id_found',
            'fujala_high_committees.id as  fujala_high_committee_id_found'
        ...
        return view('fujala_high_committee_indiv_info', compact('fujala_high_committee_info'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(FujalaHighCommittee $fujalaHighCommittee)
    {
        //
    }
     ...
     *
     * @param  \App\Http\Requests\UpdateFujalaHighCommitteeRequest  $request
     * @param  \App\Models\FujalaHighCommittee  $fujalaHighCommittee
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateFujalaHighCommitteeRequest $request, FujalaHighCommittee $fujalaHighCommittee)
    {
        ...
        $detail_ids_from_db=FujalaHighCommitteeDetail::where(array('fujala_high_committee_id'=>$shura_id))->pluck('id')->toArray() ;
        ...
        try{*/
                ...
                FujalaHighCommittee::where(array('id'=>$shura_id))->update(['creation_date'=>$creation_date_formatted,'expiry_date'=>$expiry_date_formatted]);



                $FujalaHighCommitteeDetailToDelete=FujalaHighCommitteeDetail::whereIn('id',$ids_to_delete)->get();

                for($j=0; $j<count($FujalaHighCommitteeDetailToDelete); $j++){


                    $photo_found = $FujalaHighCommitteeDetailToDelete[$j]['photo'];
                ...
                // FujalaHighCommitteeDetail::whereIn('id', $ids_to_delete)->delete();
                $result_delete=FujalaHighCommitteeDetail::whereIn('id', $ids_to_delete)->delete();
        ...
        $photo_index=0;
            ...
            $detail_id_found= $detail_ids[$i];
                ...
                FujalaHighCommitteeDetail::where(array('id'=>$detail_id_found))->update($update_info);
                     ...
                     /*FujalaHighCommitteeDetail::where(array('id'=>$detail_id_found))->update(['member_name'=>$person_name_found,'position'=>$position_found,'address'=>$address_found,
                        'educational_qualification'=>$education_found,'mobile'=>$mobile_no_found]);*/
                ...
                $member_info = ['fujala_high_committee_id'=>$shura_id,'member_name'=>$person_name_found,'position'=>$position_found,'address'=>$address_found,
                        'educational_qualification'=>$education_found,'mobile'=>$mobile_no_found];
                ...
                if($photo_uploaded){
                    $member_info['photo']=$imagename_new;
                     ...
                     FujalaHighCommitteeDetail::create($member_info);   
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(FujalaHighCommittee $fujalaHighCommittee)
    {
        //
    }
    ...
    public function search_fujala_committee(Request $request){
            ...
            $query = "SELECT *, ($matchAgainst) AS relevance 
                      FROM fujala_high_committee_details   
    ...
    }//end of function search_fujala_committee


    


    public function fujala_high_committee_member_indiv(Request $request, $id){
        ...
        $current_committee_query=FujalaHighCommittee::
            ...
            join('fujala_high_committee_details',
                'fujala_high_committees.id', '=',
                'fujala_high_committee_details.fujala_high_committee_id')
            ->where('fujala_high_committee_details.id','=',$id)
            ->select('fujala_high_committees.*','fujala_high_committee_details.*', 
                'fujala_high_committee_details.id as  fujala_high_committee_details_id_found',
                'fujala_high_committees.id as foundation_committee_id_found'
    ...
    }// end of function fujala_high_committee_member_indiv
}

@extends('layouts/app_account_delete')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <h1 style="text-align:center;">Delete request for account in An Noor Foundation App</h1>
               ...
               <div class="notice_indiv">
                  ...
                  <form method="POST" enctype="multipart/form-data" action="#" id="delete_account_form" name="delete_account_form">
                  ...
                  <!-- end of class person_info_section_indiv -->
                    ...
                    ?>
                     ...
                     <div class="person_info_section_indiv">
                           ...
                           <div class="person_info_indiv"><span class="inline_block person_info_label">Mobile Number: </span><input type="text" value="" required="required" class="person_name" 
                            name="user_name" />
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Password:</span> <input type="password" value="" required="required" class="position" name="password" />
                           </div>
...
/*
 ...
 $('#delete_account_form').submit(function(e) {
   ...
   $("#result").html('<span  style="color:green;">Submitted for admin review</span>');

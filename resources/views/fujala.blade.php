            ...
            $(document).ready(function(){
               ...
               columns: [
                  ...
                  { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                        ...
                        { data: 'social_organizational_contribution', name:'social_organizational_contribution' },
               ...
               $(document).on( 'click', '.approve_or_disapprove',function(){
                     ...
                     $.ajax({
                        ...
                        data:{"_token": _token ,'id':userId, 'approved_found':approved_found,'user_type':2},

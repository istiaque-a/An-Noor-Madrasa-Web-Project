            ...
            <div class="card">
               ...
               <div class="notice_indiv">
                  ...
                  <form method="POST" enctype="multipart/form-data" action="<?php echo route(
                  	'add_majlishe_shura_now'); ?>" id="majlishe_shura_form" name="majlishe_shura_form">
                  ...
                  <br/>
                  <input type="text" id="total_persons" name="total_persons" value="0" />

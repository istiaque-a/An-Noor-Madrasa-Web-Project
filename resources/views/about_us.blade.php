            ...
            <div class="card">
               ...
               <div class="notice_indiv">
                  ...
                  ?>
                    ...
                    'add_aboutus_now'); ?>" id="aboutus_form" name="aboutus_form">
                   ...
                   <div id="add_person_container" class="mt-3">
                     ...
                     <br/>
                     <textarea id="aboutus_body" name="aboutus_body" placeholder="About Us " class="form-control"><?php echo $aboutus; ?></textarea>
...
options = { 
 ...
 $('#aboutus_form').submit(function(e) {

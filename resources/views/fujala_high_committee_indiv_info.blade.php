            ...
            <div class="card">
               ...
               <div class="notice_indiv">
                  ...
                  <form method="POST" enctype="multipart/form-data" action="<?php echo route(
                    'update_fujala_high_committee_now'); ?>" id="majlishe_shura_form" name="majlishe_shura_form">

                     @csrf

                     <?php

                     $creation_date=$fujala_high_committee_info[0]['creation_date'];

                     $expiry_date=$fujala_high_committee_info[0]['expiry_date'];
                     ...
                     $fujala_high_committee_id_found= $fujala_high_committee_info[0]['fujala_high_committee_id_found'];
                     ...
                     ?>
                        ...
                        <div class="notice_title col-sm-5">
                           Creation Date <input id="creation_date" name="creation_date" type="text" readonly="readonly" value="<?php echo $creation_date_formatted; ?>" placeholder="Creation Date" />
                           
                        </div>

                        <div class="notice_title col-sm-5">
                           Expiry Date <input id="expiry_date" name="expiry_date" type="text" readonly="readonly" value="<?php echo $expiry_date_formatted; ?>" placeholder="Expiry Date" />
                  ...
                  <?php
                    ...
                    foreach($fujala_high_committee_info as $fujala_high_committee_info_indiv){

                        


                       // echo " masjlishe_shuras_info_indiv id = ".$fujala_high_committee_info_indiv
                       // ['fujala_high_committee_id_found'];
                        ...
                        <div class="masjlishe_shura_indiv">
                             Creation date: <?php echo 
                    $fujala_high_committee_info_indiv['creation_date']; ?> Expiry date: <?php echo $fujala_high_committee_info_indiv['expiry_date']; ?>  
                     ...
                     <div class="person_info_section_indiv">
                        <?php echo $counter+1; ?> )
                           ...
                           <div class="person_info_indiv"><span class="inline_block person_info_label">Name: </span><input type="text" value="<?php echo $fujala_high_committee_info_indiv['member_name']; ?>" required="required" class="person_name" name="person_name[<?php echo $counter; ?>]" />
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Position:</span> <input type="text" value="<?php echo $fujala_high_committee_info_indiv['position']; ?>" required="required" class="position" name="position[<?php echo $counter; ?>]" />
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Address:</span> <textarea class="address" name="address[<?php echo $counter; ?>]" required="required" ><?php echo $fujala_high_committee_info_indiv['address']; ?></textarea>
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Educational Qualification:</span> <textarea name="education[]" ><?php echo $fujala_high_committee_info_indiv['educational_qualification']; ?></textarea>
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Mobile No:</span> <input text="tel" required="required" class="mobile_no" name="mobile_no[<?php echo $counter; ?>]" value="<?php echo $fujala_high_committee_info_indiv['mobile']; ?>" />
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">

                            <?php

                               $photo_found=$fujala_high_committee_info_indiv['photo'];
                               ...
                               if($photo_found!=trim("")){
                                ...
                                ?>
                                 ...
                                 <img src="<?php echo url('/'); ?>/thumbnails/<?php echo $photo_found; ?>" alt="aaaa" />   
                           ...
                           Photo:</span><input type="file" class="photo" value="" name="photo[]"  />
                           </div>



                           <input type="hidden" name="detail_id[<?php echo $counter; ?>]" value="<?php echo $fujala_high_committee_info_indiv->fujala_high_committee_details_id_found; ?>" />
                           <a href="#" class="remove_btn" data-counter="<?php echo $counter; ?>" >Remove</a>
                ...
                <div id="add_person_container" class="mt-3">
                    ...
                    <br/>
                  <input type="hidden" id="total_persons" name="total_persons" value="<?php echo $counter; ?>" />
                  <br/>
                  ...
                  <input type="hidden" name="shura_id" value="<?php echo $fujala_high_committee_id_found; ?>" />
                    <br/>
...
options = { 
	...
	$(document).ready(function(){
      ...
      $("#majlishe_shura_form").validate({
		...
		$("#btn_add_person_0000").click(function(){
			++counter;
      ...
      $(document).on('click','.remove_btn_00000', function(e){

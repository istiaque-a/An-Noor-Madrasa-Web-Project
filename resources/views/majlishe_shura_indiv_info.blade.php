            ...
            <div class="card">
               ...
               <div class="notice_indiv">
                  ...
                  <?php
                    ...
                    foreach($masjlishe_shura_info as $masjlishe_shuras_info_indiv){

                        


                       // echo " masjlishe_shuras_info_indiv id = ".$masjlishe_shuras_info_indiv
                    ...
                    $masjlishe_shuras_info_indiv['creation_date']; ?> Expiry date: <?php echo $masjlishe_shuras_info_indiv['expiry_date']; ?>  
                     ...
                     <div class="person_info_section_indiv">
                        <?php echo $counter+1; ?> )
                           ...
                           <div class="person_info_indiv"><span class="inline_block person_info_label">Name: </span><input type="text" value="<?php echo $masjlishe_shuras_info_indiv['member_name']; ?>" required="required" class="person_name" name="person_name[<?php echo $counter; ?>]" />
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Position:</span> <input type="text" value="<?php echo $masjlishe_shuras_info_indiv['position']; ?>" required="required" class="position" name="position[<?php echo $counter; ?>]" />
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Address:</span> <textarea class="address" name="address[<?php echo $counter; ?>]" required="required" ><?php echo $masjlishe_shuras_info_indiv['address']; ?></textarea>
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Educational Qualification:</span> <textarea name="education[]" ><?php echo $masjlishe_shuras_info_indiv['educational_qualification']; ?></textarea>
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Mobile No:</span> <input text="tel" required="required" class="mobile_no" name="mobile_no[<?php echo $counter; ?>]" value="<?php echo $masjlishe_shuras_info_indiv['mobile']; ?>" />
                           </div>
                           ...
                           <div class="person_info_indiv"><span class="inline_block person_info_label">
                            ...
                            <?php
                               ...
                               $photo_found=$masjlishe_shuras_info_indiv['photo'];
                           ...
                           <input type="hidden" name="detail_id[<?php echo $counter; ?>]" value="<?php echo $masjlishe_shuras_info_indiv->majlishe_shura_detail_id_found; ?>" />
                ...
                <div id="add_person_container" class="mt-3">
                  ...
                  <input type="hidden" name="shura_id" value="<?php echo $majlishe_shura_id_found; ?>" />
                    <br/>

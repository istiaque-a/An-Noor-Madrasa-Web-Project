        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                     ...
                     <div class="container">
                              <h2>All  Foundation Parishads</h2>
               ...
               <div class="notice_indiv">
                  ...
                  <?php
                    ...
                    $counter=0;
                    foreach($fujala_high_committee_all as $fujala_high_committee_all_indiv){
                        ++$counter;
                        ?>

                        <div class="masjlishe_shura_indiv">
                            <?php echo $counter; ?> ) Creation date: <?php echo $fujala_high_committee_all_indiv[
                                'creation_date']; ?> Expiry date: <?php echo $fujala_high_committee_all_indiv[
                                'expiry_date']; ?> <a href="{{route('fujala_high_committee_indiv', $fujala_high_committee_all_indiv['id'])}}">Details</a>

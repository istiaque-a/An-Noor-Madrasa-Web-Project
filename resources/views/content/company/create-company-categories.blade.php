...
<div class="card"   data-capture=".base, .date, .datepicker">
  ...
  <div class="card-body">
    <div id="company_create_area" class_0="d-flex justify-content-center">
      ...
      <div><h4  class="text-center py-3">Create Company Categories</h4></div>
      
        <form method="POST" enctype="multipart/form-data" id="form_company_category_name" action="{{URL::to('/create-company-category-now')}}"  class="requires-validation g-3" novalidate  >
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-4_00">
              <label for="company_category_name" class="form-label  ">Company Category Name</label>
              <input type="text" name="company_category_name" class="form-control" id="company_category_name" placeholder="Company Category Name" value=""  required>

              <div class="invalid-feedback" id="company_category_name_error">
                Please give the name of the company category.
              </div>
          ...
          <div class="row mb-3">
            <div class="col-sm-4_00">
              ...
              <input type="text" name="category_description" class="form-control" id="category_description" placeholder="Category Description" value="" >
        ...
        <div class="col-12_000 text-start">
          <button type="submit" class="btn  btn-danger">Create the Company Category</button>
        </div>
      </form>
...
*/
    ...
    $('#form_company_category_name').submit(function() { 

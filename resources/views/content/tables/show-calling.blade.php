      ...
      <!-- <div class="col-sm-6_000" >
        ...
        <div class="text-end">
            ...
            <div id="document_itself_photo">
                ...
                <a href="{{URL::to('/uploads/calling_photo/'.$user->vaccine_photo)}}" data-fancybox="images" data-caption="calling record">
                    <img  src="{{URL::to('/thumbnails/calling_photo/'.$user->vaccine_photo)}}" alt="photo" />
                </a>
            </div>
              ...
              if(!$is_pdf){
                ...
                <div class="user_doc_indiv">
                  ...
                  <a href="{{URL::to('/uploads/calling_photo/'.$large_image )}}" data-fancybox="images" data-caption="<?php echo $description; ?>">
                    <img  src="{{URL::to('/thumbnails/calling_photo/'.$thumbnail)}}"  onerror="this.onerror=null;this.src='<?php echo $default_image; ?>';" alt="photo" />

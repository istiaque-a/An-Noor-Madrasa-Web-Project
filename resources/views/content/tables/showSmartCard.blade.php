  ...
  <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-sm-6_0000">
        ...
        <div id="smart_card_person_passport_status" class="indiv_status_show rounded text-center p-3 mt-4 float-start_000 fw-bold">
          STATUS: APPROVED
        </div><!-- end of id smart_card_person_passport_status-->
        <div class="clearfix"></div>
      </div><!-- end of col-sm-6 -->

      <div class="col-sm-6_0-000" >
        ...
        <div class="text-end">
            ...
            <div id="document_itself_photo">
              ...
              <!-- <p class="imglist" style="max-width: 1000px;"> -->
                ...
                <a href="{{URL::to('/uploads/nid_photo/'.$user->nid_photo)}}" data-fancybox="images" data-caption="NID card">
                    <img  src="{{URL::to('/thumbnails/nid_photo/'.$user->nid_photo)}}" alt="photo" />
                </a>

    ...
    <div id="result" class="text-center"></div>
        ...
        <div class="row  mb-3 gy-3">
          ...
          <div class="col-sm-4">
            ...
            <input type="date" name="medical_date" class="form-control" id="medical_date" value="" placeholder="Medical Date">
        ...
        <div class="row  mb-3 gy-3">
          ...
          <div class="col-sm-4">
            ...
            <input type="date" name="departure_date" class="form-control" id="departure_date" value="" placeholder="Departure Date">
          ...
          <div class="col-sm-4">
            ...
            <input type="date" name="esd_to_reach" class="form-control" id="esd_to_reach" value="" placeholder="ESD to Reach">
        ...
        <div class="user_add_file_indiv mb-5">
          ...
          <input type="text" value="" id="passport_doc_labels"  name="passport_doc_labels">
          <input type="text" value="" id="passport_docs_names" name="passport_docs_names" />
          <input type="text" value="" id="nid_docs_names" name="nid_docs_names" />
    ...
    <script id="template-upload" type="text/x-tmpl">
      {% for (var i=0, file; file=o.files[i]; i++) { %}
          <tr class="template-upload fade{%=o.options.loadImageFileTypes.test(file.type)?' image':''%}">
              <td>
                  <input type="text" value="1111" class="label_input label_input_""{%=i%}"  /><span class="preview"></span>
              </td>
              <td>

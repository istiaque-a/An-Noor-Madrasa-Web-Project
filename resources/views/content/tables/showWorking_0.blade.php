...
@section('title', 'Working Selection')
        ...
        <div class="text-end">
            ...
            <div id="document_itself_photo">
              ...
              <!-- <p class="imglist" style="max-width: 1000px;"> -->
                ...
                <a href="{{URL::to('/uploads/working_selection/'.$user->working_selection)}}" data-fancybox="images" data-caption="Working selection doc">
                    <img  src="{{URL::to('/thumbnails/working_selection/'.$user->working_selection)}}" alt="photo" />
                </a>

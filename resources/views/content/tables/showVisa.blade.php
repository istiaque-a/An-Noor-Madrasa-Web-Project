...
@section('title', 'Visa/stamping Docs')
      ...
      <!-- <div class="col-sm-6_000" >
        ...
        <div class="text-end">
            ...
            <div id="document_itself_photo">
                ...
                <a href="{{URL::to('/uploads/visa_stamping_photo/'.$user->vaccine_photo)}}" data-fancybox="images" data-caption="visa_stamping record">
                    <img  src="{{URL::to('/thumbnails/visa_stamping_photo/'.$user->vaccine_photo)}}" alt="photo" />
                </a>
            </div>
              ...
              if(!$is_pdf){
                ...
                <div class="user_doc_indiv">
                  ...
                  <a href="{{URL::to('/uploads/visa_stamping_photo/'.$large_image )}}" data-fancybox="images" data-caption="<?php echo $description; ?>">
                    <img  src="{{URL::to('/thumbnails/visa_stamping_photo/'.$thumbnail)}}"  onerror="this.onerror=null;this.src='<?php echo $default_image; ?>';" alt="photo" />

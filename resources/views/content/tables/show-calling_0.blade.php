        ...
        <div class="text-end">
            ...
            <div id="document_itself_photo">
              ...
              <!-- <p class="imglist" style="max-width: 1000px;"> -->
                ...
                <a href="{{URL::to('/uploads/calling_photo/'.$user->calling_photo)}}" data-fancybox="images" data-caption="Calling doc">
                    <img  src="{{URL::to('/thumbnails/calling_photo/'.$user->calling_photo)}}" alt="photo" />
                </a>

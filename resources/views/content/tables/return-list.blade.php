...
@section('title', 'All Returned Candidates')
...
<div id="above_table_info_area" class="mb-2">
  ...
  <div class="float-start_00 text-left" id="above_table_info_area_left">
    <span class="fw-bolder mb-4">All Returned Candidates </span>    
  </div>
  ...
  $(document).ready(function(){
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'passport_returned_explanation', name: 'passport_returned_explanation'},

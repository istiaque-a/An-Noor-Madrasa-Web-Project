        ...
        <form method="POST" enctype="multipart/form-data" id="form-payment-schedule" action="{{URL::to('/payment/create-schedule-now')}}"  class="requires-validation g-3" novalidate  >
          ...
          <div class="row mb-3"> 
            <div class="col-sm-4_00">
              ...
              <input type="text" name="last_date" class="form-control" id="last_date" placeholder="Last Date" value="" readonly >
          ...
          <div class="row mb-3">
            <div class="col-sm-4_00">
              ...
              <input type="text" name="amount" class="form-control" id="amount" placeholder="Amount" value="" >

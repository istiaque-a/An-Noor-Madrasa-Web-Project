            ...
            <div class="card">
               ...
               <div class="notice_indiv">
                  ...
                  <?php
                    ...
                    $counter=0;
                    foreach($foundation_committee_all as $foundation_committee_all_indiv){
                        ++$counter;
                        ?>

                        <div class="masjlishe_shura_indiv">
                            <?php echo $counter; ?> ) Creation date: <?php echo $foundation_committee_all_indiv[
                                'creation_date']; ?> Expiry date: <?php echo $foundation_committee_all_indiv[
                                'expiry_date']; ?> <a href="{{route('foundation_committee_indiv', $foundation_committee_all_indiv['id'])}}">Details</a>

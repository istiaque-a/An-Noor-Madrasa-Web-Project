            ...
            <div class="card">
               ...
               <div class="notice_indiv">
                  ...
                  ?>
                    ...
                    'add_mission_now'); ?>" id="mission_form" name="mission_form">
                   ...
                   <div id="add_person_container" class="mt-3">
                     ...
                     <br/>
                     <textarea id="mission_body" name="mission_body" placeholder="Mission " class="form-control"><?php echo $mission; ?></textarea>
...
options = { 
 ...
 $('#mission_form').submit(function(e) {

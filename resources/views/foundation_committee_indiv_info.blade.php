            ...
            <div class="card">
               ...
               <div class="notice_indiv">
                  ...
                  <form method="POST" enctype="multipart/form-data" action="<?php echo route(
                    'update_foundation_committee_now'); ?>" id="majlishe_shura_form" name="majlishe_shura_form">

                     @csrf

                     <?php

                     $creation_date=$foundation_committee_info[0]['creation_date'];

                     $expiry_date=$foundation_committee_info[0]['expiry_date'];
                     ...
                     $foundation_committee_id_found= $foundation_committee_info[0]['foundation_committee_id_found'];
                  ...
                  <?php
                    ...
                    foreach($foundation_committee_info as $foundation_committee_info_indiv){

                        


                       // echo " masjlishe_shuras_info_indiv id = ".$foundation_committee_info_indiv
                       // ['foundation_committee_id_found'];
                    ...
                    $foundation_committee_info_indiv['creation_date']; ?> Expiry date: <?php echo $foundation_committee_info_indiv['expiry_date']; ?>  
                     ...
                     <div class="person_info_section_indiv">
                        <?php echo $counter+1; ?> )
                           ...
                           <div class="person_info_indiv"><span class="inline_block person_info_label">Name: </span><input type="text" value="<?php echo $foundation_committee_info_indiv['member_name']; ?>" required="required" class="person_name" name="person_name[<?php echo $counter; ?>]" />
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Position:</span> <input type="text" value="<?php echo $foundation_committee_info_indiv['position']; ?>" required="required" class="position" name="position[<?php echo $counter; ?>]" />
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Address:</span> <textarea class="address" name="address[<?php echo $counter; ?>]" required="required" ><?php echo $foundation_committee_info_indiv['address']; ?></textarea>
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Educational Qualification:</span> <textarea name="education[]" ><?php echo $foundation_committee_info_indiv['educational_qualification']; ?></textarea>
                           </div>

                           <div class="person_info_indiv"><span class="inline_block person_info_label">Mobile No:</span> <input text="tel" required="required" class="mobile_no" name="mobile_no[<?php echo $counter; ?>]" value="<?php echo $foundation_committee_info_indiv['mobile']; ?>" />
                           </div>
                           ...
                           <div class="person_info_indiv"><span class="inline_block person_info_label">
                            ...
                            <?php
                               ...
                               $photo_found=$foundation_committee_info_indiv['photo'];
                           ...
                           <input type="hidden" name="detail_id[<?php echo $counter; ?>]" value="<?php echo $foundation_committee_info_indiv->foundation_committee_details_id_found; ?>" />
                ...
                <div id="add_person_container" class="mt-3">
                  ...
                  <input type="hidden" name="shura_id" value="<?php echo $foundation_committee_id_found; ?>" />
                    <br/>
